...
import { BalanceGeneral } from '../interfaces/reporte.interface';
...
export class ReporteService {
  ...
  getLibroMayor(
    ...
    anio?: number,
    mes?: number,
  ): Observable<LibroMayorResponseDto> {
    let params = new HttpParams().set('empresaRut', empresaRut);
    if (anio !== undefined) params = params.set('anio', anio.toString());
    if (mes !== undefined) params = params.set('mes', mes.toString());

    return this.http.get<LibroMayorResponseDto>(
      `${this.apiUrl}/libro-mayor/${cuentaCodigo}`,
      { params },
    );
  }
  ...
  getEvolucionResultados(
    ...
    anio?: number,
    mes?: number,
  ): Observable<EvolucionResultados> {
    let params = new HttpParams().set('empresaRut', empresaRut);
    if (anio !== undefined) params = params.set('anio', anio.toString());
    if (mes !== undefined) params = params.set('mes', mes.toString());

    return this.http.get<EvolucionResultados>(
      `${this.apiUrl}/evolucion-resultados`,
      { params },
    );
  }
  ...
  getLibroDiario(
    ...
    anio?: number,
    mes?: number,
  ): Observable<LibroDiarioResponseDto> {
    let params = new HttpParams().set('empresaRut', empresaRut);
    if (anio !== undefined) params = params.set('anio', anio.toString());
    if (mes !== undefined) params = params.set('mes', mes.toString());

    return this.http.get<LibroDiarioResponseDto>(
      `${this.apiUrl}/libro-diario`,
      { params },
    );
  }

  getLibroMayorCompleto(
    empresaRut: string,
    anio?: number,
    mes?: number,
  ): Observable<LibroMayorCompletoResponse> {
    let params = new HttpParams().set('empresaRut', empresaRut);
    if (anio !== undefined) params = params.set('anio', anio.toString());
    if (mes !== undefined) params = params.set('mes', mes.toString());

    return this.http.get<LibroMayorCompletoResponse>(
      `${this.apiUrl}/libro-mayor-completo`,
      { params },
    );
  }
